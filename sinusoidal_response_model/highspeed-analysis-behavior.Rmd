...
# denotes correct rejection (key was not pressed and stimulus was upright): trials in this condition will be used in  following analysis
dt_events$sdt_type[
...
#0 denotes upright, 1 denotes upside-down
```
...
plot_behav_rep_all = ggplot(data = plot_data, mapping = aes(
  ...
  scale_fill_gradient(low = "dodgerblue", high = "red", guide = 'none') +
  coord_capped_cart(left = "both", bottom = "both", expand = TRUE, ylim = c(0,100)) +
