...
ana_conditions = 'eeg_mental_simulation_glm'
...
beta_list = Parallel(n_jobs=17)(delayed(l1_GLM_pm)(subject) for subject in sub_list)

# In[LEVEL 2 GLM AND THRESHOLDED THE T-MAP]:

# load the beta list
ms_beta_list = [beta_list[i] for i in range(len(sub_list))]
