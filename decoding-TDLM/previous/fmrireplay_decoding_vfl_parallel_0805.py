...
#     if trials >= 0 and trials <= 17 and run == 1:
#         return 1
#     elif trials > 18 and trials <= 35 and run == 1:
#         return 2
#     elif trials >= 36 and trials <= 53 and run == 1:
#         return 3
#     elif trials > 54 and trials <= 71 and run == 1:
#         return 4
#     elif trials >= 0 and trials <= 17 and run == 2:
#         return 5
#     elif trials > 18 and trials <= 35  and run == 2:
#         return 6
#     elif trials >= 36 and trials <= 53  and run == 2:
#         return 7
#     elif trials > 54 and trials <= 71  and run == 2:
#         return 8
#     else: 
#         return 9
...
# for test
subject=sub_list[0]
mask_index=mask_index_list[5]
bold_delay_task=bold_delay_task_list[4]
...
def decoding(subject,mask_index,bold_delay_task):
    ...
    plt.title('%s decoding probability of VFL-VFL (%1.0f th TR peak) %s' % (subject,bold_delay_task,mask_name))
    plt.xlabel("label")
    plt.ylabel("probability")
    plt.savefig(opj(path_out_figs,'%s decoding probability of VFL-VFL (%1.0f th TR peak) %s.png' % (subject,bold_delay_task,mask_name)),
    ...
    plt.suptitle('%s multi-TR decoding probability of VFL-VFL (%1.0f th TR peak) %s' % (subject,bold_delay_task,mask_name))
    plt.savefig(opj(path_out_figs,'%s multi-TR decoding probability of VFL-VFL (%1.0f th TR peak) %s.png' % (subject,bold_delay_task,mask_name)),
                dpi = 400,bbox_inches = 'tight')
    plt.show() 
    # In[]
